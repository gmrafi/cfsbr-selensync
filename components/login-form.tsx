  ...
  return (
    <div className="w-full max-w-md space-y-8">
      <div className="space-y-4 text-center">
        ...
        <p className="text-lg text-gray-600">Sign in to your OrbitEdge Global account</p>
      </div>
      ...
      <form action={formAction} className="space-y-6">
        ...
        <div className="text-center text-gray-600">
          ...
          <Link href="/auth/sign-up" className="text-[#4e6aff] hover:text-[#3d54e6] font-medium">
            Sign up for free
          </Link>
        </div>
      </form>
